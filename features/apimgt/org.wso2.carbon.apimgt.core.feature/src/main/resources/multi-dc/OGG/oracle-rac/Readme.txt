...
to alter the sequences on a sample scenario where you have 3 master DB instances in 3 DC's      #
                                                                                                #
DC1                                                                                             #
CREATE SEQUENCE REG_LOG_SEQUENCE START WITH 1 INCREMENT BY 3 CACHE 20                           #
                                                                                                #
DC2                                                                                             #
CREATE SEQUENCE REG_LOG_SEQUENCE START WITH 2 INCREMENT BY 3 CACHE 20                           #
                                                                                                #
DC3                                                                                             #
CREATE SEQUENCE REG_LOG_SEQUENCE START WITH 3 INCREMENT BY 3 CACHE 20                           #
                                                                                                #
#################################################################################################