        ...
        try {
            ...
            if (configDTO.isUsage_upload_cleanup_task_enabled()) {
                ...
                executor.scheduleAtFixedRate(
                        new APIUsageFileCleanupTask(Long.toString(configDTO.getUsage_upload_retention_days())), 0,
                        syncPeriod, TimeUnit.MINUTES);
                log.info(
                        "API Usage File Cleanup has been successfully scheduled at a rate of once every " + syncPeriod +
                                " minutes");
            }
