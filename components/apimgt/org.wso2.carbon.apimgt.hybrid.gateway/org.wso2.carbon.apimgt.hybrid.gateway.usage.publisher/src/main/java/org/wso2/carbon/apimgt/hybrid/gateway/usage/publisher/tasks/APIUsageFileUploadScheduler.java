    ...
    public static void schedule() {
        ...
        try {
            ...
            if (configDTO.isUsage_upload_task_enabled()) {
                ...
                executor.scheduleAtFixedRate(new APIUsageFileUploadTask(), 0, syncPeriod, TimeUnit.MINUTES);
                log.info("API Usage File Upload has been successfully scheduled at a rate of once every " + syncPeriod +
                        " minutes");
            }
