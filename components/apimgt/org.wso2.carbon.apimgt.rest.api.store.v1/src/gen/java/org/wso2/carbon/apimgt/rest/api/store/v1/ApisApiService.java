...
public interface ApisApiService {
      ...
      public Response apisApiIdSwaggerGet(String apiId, String environmentName, String ifNoneMatch, String xWSO2Tenant, String query, MessageContext messageContext) throws APIManagementException;
