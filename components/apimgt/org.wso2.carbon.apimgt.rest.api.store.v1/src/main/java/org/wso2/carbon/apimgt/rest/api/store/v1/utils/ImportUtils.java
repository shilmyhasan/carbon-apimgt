...
public class ImportUtils {
    ...
    public static void addApplicationKey(String username, Application application, ApplicationKeyDTO applicationKeyDTO,
        ...
        if (!update) {
            apiConsumer.requestApprovalForApplicationRegistration(username, application.getName(),
                    ...
                    application.getGroupId(), jsonParams, applicationKeyDTO.getKeyManager(), null);
        } else {
            apiConsumer.updateAuthClient(username, application.getName(), applicationKeyDTO.getKeyType().toString(),
