...
public class KeyManagerMappingUtil {
    ...
    public static KeyManagerAPIUsagesDTO toKeyManagerAPIUsagesDTO(AdminContentSearchResult result) {
        ...
        if (result != null) {
            ...
            //TODO : In Master branch this uses keyManagerAPIUsagesDTO.setApiCount(result.getApiTotal());.
            // getApiTotal has come from https://github.com/wso2/carbon-apimgt/pull/12200. Need tp clarify this
