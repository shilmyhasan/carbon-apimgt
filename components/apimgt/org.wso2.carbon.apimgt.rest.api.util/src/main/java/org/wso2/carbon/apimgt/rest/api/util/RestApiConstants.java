...
public final class RestApiConstants {
    ...
    public static final String REST_API_STORE_VERSION="v0.12";
    public static final String REST_API_PUBLISHER_VERSION="v0.12";
    ...
    public static final String REST_API_ADMIN_VERSION="v0.12";
