...
public interface APIConsumer extends APIManager {
     ...
     * @throws APIManagementException if failed to count the number of subscriptions.
     */
    Integer getSubscriptionCountByApplicationId(Subscriber subscriber,int applicationId,String groupingId) throws APIManagementException;
     ...
     * @throws APIManagementException if failed to remove subscription details from database
     */
    void removeSubscription(APIIdentifier identifier, String userId, int applicationId,String groupId) throws APIManagementException;
