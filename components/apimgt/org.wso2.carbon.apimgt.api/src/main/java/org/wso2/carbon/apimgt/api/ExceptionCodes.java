...
ExceptionCodes implements ErrorHandler {
    ...
    /*
     * Cannot use 900706 because it is for property values. 900707 is a generic one for any invalid character
     * hence it accepts an error description
     */
    CONTAIN_INVALID_CHARACTERS(900707, "contain invalid characters", 400,
            "%s"),
    ...
    BLOCK_CONDITION_UNSUPPORTED_APP_ID_NAME(900978, "Block Condition Error", 400, "Application ID or Name does not " +
            "exist"),
    API_CONTEXT_MALFORMED_EXCEPTION(900253, "API context is malformed", 400, "'%s'"),
    ...
    BLOCK_CONDITION_RETRIEVE_PARAMS_EXCEPTION(900988, "Block conditions retrieval error", 400, "Provided query parameters are not valid"),
    BLOCK_CONDITION_RETRIEVE_FAILED(900989, "Failed to get Block conditions", 500, "Failed to retrieve Block conditions from the database"),
    INVALID_BLOCK_CONDITION_VALUES(900254, "Error while retrieving Block Conditions", 500, "Invalid format for condition values"),
