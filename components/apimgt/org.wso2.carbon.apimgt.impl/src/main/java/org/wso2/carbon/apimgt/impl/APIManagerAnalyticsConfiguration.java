...
public class APIManagerAnalyticsConfiguration {
    ...
    public void setAPIManagerConfiguration(APIManagerConfiguration config){
        ...
        if (analyticsEnabled){
            ...
            String skipWorkflowDataPublisherStr = config.getFirstProperty(APIConstants
                    .API_USAGE_SKIP_WORKFLOW_EVENT_RECEIVER_CONN);
            skipWorkFlowEventReceiverConnection = skipWorkflowDataPublisherStr != null && JavaUtils.isTrueExplicitly
                    (skipWorkflowDataPublisherStr);
