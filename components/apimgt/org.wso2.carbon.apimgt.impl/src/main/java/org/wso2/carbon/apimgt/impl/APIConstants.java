...
public final class APIConstants {
    ...
    public static final String APPLICATION_FORCE_DOWNLOAD_MEDIA_TYPE = "application/force-download";
    ...
    public static final String API_USAGE_SKIP_WORKFLOW_EVENT_RECEIVER_CONN = API_ANALYTICS +
            "SkipWorkflowEventPublisher";
