...
public final class APIConstants {
    ...
    public static final String CORS_CONFIGURATION_ENABLE_WS_ADDITIONAL_VALIDATION = CORS_CONFIGURATION
            + "EnableWSAdditionalCORSValidation";
    ...
    public static final String REGEX_ILLEGAL_CHARACTERS_FOR_API_METADATA_WO_SPACE =
            "[~!@#;%^*()+={}|<>\"\',\\[\\]&/$\\\\ ]";
