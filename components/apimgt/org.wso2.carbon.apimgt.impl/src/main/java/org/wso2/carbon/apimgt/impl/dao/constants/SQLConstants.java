...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String GET_LIGHT_WEIGHT_API_INFO_BY_API_IDENTIFIER = "SELECT API_ID,API_UUID,API_PROVIDER," +
            "API_NAME,API_VERSION,CONTEXT,CONTEXT_TEMPLATE,API_TYPE,STATUS FROM AM_API WHERE " +
    ...
    public static final String GET_DEFAULT_VERSION_SQL =
            "SELECT DEFAULT_API_VERSION FROM AM_API_DEFAULT_VERSION WHERE API_NAME= ? AND ORGANIZATION= ? ";

    public static final String GET_MIGRATED_API_PRODUCT_DEFAULT_VERSION_SQL =
            "SELECT API_VERSION FROM AM_API WHERE API_NAME= ? AND ORGANIZATION= ? AND API_VERSION= ? " +
    ...
    public static final String REMOVE_API_DEFAULT_VERSION_SQL =
            "DELETE FROM AM_API_DEFAULT_VERSION WHERE API_NAME = ? AND ORGANIZATION = ?";

    public static final String GET_PUBLISHED_DEFAULT_VERSION_SQL =
            "SELECT PUBLISHED_DEFAULT_API_VERSION FROM AM_API_DEFAULT_VERSION WHERE API_NAME= ? AND ORGANIZATION= ? ";

    public static final String GET_MIGRATED_API_PRODUCT_PUBLISHED_DEFAULT_VERSION_SQL =
            "SELECT API_VERSION FROM AM_API WHERE API_NAME= ? AND ORGANIZATION= ? AND API_VERSION= ? AND " +
    ...
    public static final String GET_API_IDENTIFIER_BY_UUID_SQL =
            "SELECT API_PROVIDER, API_NAME, API_VERSION, ORGANIZATION FROM AM_API WHERE API_UUID = ?";
    ...
    public static final String RETRIEVE_DEFAULT_VERSION = "SELECT DEFAULT_API_VERSION,PUBLISHED_DEFAULT_API_VERSION " +
            "FROM AM_API_DEFAULT_VERSION WHERE API_NAME = ? AND ORGANIZATION =?";
    public static final String RETRIEVE_DEFAULT_VERSION_WITH_API_INFO = "SELECT AM_API.API_PROVIDER, AM_API.API_NAME, "
            ...
            + "WHERE AM_API.API_NAME = ? AND AM_API.ORGANIZATION = ? AND AM_API.API_VERSION = ?";
    ...
    public static final String GET_API_VERSIONS =
            "SELECT API.API_VERSION FROM AM_API API WHERE API.API_NAME = ? AND ORGANIZATION = ?";
    public static final String GET_API_VERSIONS_UUID =
            "SELECT API.API_UUID, API.STATUS, API.API_VERSION, API.API_PROVIDER, API.API_TYPE, API.VERSION_COMPARABLE, "
                    + "API.CONTEXT, API.CONTEXT_TEMPLATE FROM AM_API API WHERE API.ORGANIZATION = ? AND API.API_NAME = ? ";
