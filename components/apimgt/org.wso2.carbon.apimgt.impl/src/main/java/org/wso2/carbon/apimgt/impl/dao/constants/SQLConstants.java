...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String GET_LIGHT_WEIGHT_API_INFO_BY_API_IDENTIFIER = "SELECT API_ID,API_PROVIDER," +
            "API_NAME,API_VERSION,CONTEXT,API_TYPE FROM AM_API WHERE API_PROVIDER = ? AND API_NAME = ? AND " +
            "API_VERSION = ?";
    ...
    public static final String GET_SCOPE_BY_SUBSCRIBED_ID_ORACLE_SQL =
            "SELECT DISTINCT ARSM.SCOPE_NAME " +
                ...
                "INNER JOIN AM_API_PRODUCT_MAPPING APM ON APM.API_ID = API.API_ID " +
                "INNER JOIN AM_API_URL_MAPPING AUM ON AUM.URL_MAPPING_ID = apm.URL_MAPPING_ID " +
    ...
    public static final String GET_ALL_API_ARTIFACT = "SELECT ARTIFACT FROM AM_GW_PUBLISHED_API_DETAILS," +
            "AM_GW_API_ARTIFACTS WHERE AM_GW_API_ARTIFACTS.GATEWAY_LABEL =? AND " +
            "AM_GW_API_ARTIFACTS.GATEWAY_INSTRUCTION =? AND AM_GW_PUBLISHED_API_DETAILS.TENANT_DOMAIN = ? AND " +
            "AM_GW_API_ARTIFACTS.API_ID = AM_GW_PUBLISHED_API_DETAILS.API_ID";
    ...
    public static final String RETRIEVE_CORRELATION_CONFIGS_BY_STATUS =
            "SELECT AM_CORRELATION_CONFIGS.COMPONENT_NAME FROM AM_CORRELATION_CONFIGS WHERE ENABLED=?";
