...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String RETRIEVE_API_INFO_BY_IDENTIFIER_SQL = "SELECT API_UUID, API_PROVIDER, API_NAME, " +
            "API_VERSION FROM AM_API WHERE API_NAME = ? AND API_VERSION = ?";
