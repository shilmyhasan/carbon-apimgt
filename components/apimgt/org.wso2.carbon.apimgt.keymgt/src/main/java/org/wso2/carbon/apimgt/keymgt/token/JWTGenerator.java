...
public class JWTGenerator extends AbstractJWTGenerator {
    ...
    public String generateToken(TokenValidationContext validationContext) throws APIManagementException{
        ...
        String jwtHeader = buildHeader(validationContext.getValidationInfoDTO().getEndUserName(), true);
    ...
    protected Map<String, String> convertClaimMap(Map<ClaimMapping, String> userAttributes, String username)
        ...
        if (convertClaimsFromOIDCtoConsumerDialect != null && !Boolean
                .parseBoolean(convertClaimsFromOIDCtoConsumerDialect)) {
            return userClaims;
        }
        ...
        try {
            carbonToOIDCclaimMapping = new ClaimMetadataHandler()
                    .getMappingsMapFromOtherDialectToCarbon(OIDC_DIALECT_URI, claimUris, tenantDomain, true);
