...
public class GraphQLQueryAnalysisHandler extends AbstractHandler {
    ...
    private boolean analyseQuery(MessageContext messageContext, String payload) {
        try {
            ...
            queryMutationAnalyzer.handleFailure(APISecurityConstants.GRAPHQL_INVALID_QUERY, messageContext,
                    errorMessage, errorMessage);
        }
        return false;
    }

    @Override public boolean handleResponse(MessageContext messageContext) {
        return true;
    }
}
