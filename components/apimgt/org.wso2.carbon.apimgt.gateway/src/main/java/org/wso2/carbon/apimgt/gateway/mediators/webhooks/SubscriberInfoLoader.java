...
public class SubscriberInfoLoader extends AbstractMediator {
    ...
    public boolean mediate(MessageContext messageContext) {
        ...
        if (subscriber != null) {
            ...
            // sets the link header property for the content distribution request.
            // this will be referred and added to the transport headers in the synapse API
            String linkHeader = messageContext.getProperty(RESTConstants.REST_URL_PREFIX).toString() +
                    ...
                    APIMgtGatewayConstants.SUBSCRIBER_LINK_HEADER_HUB + subscriber.getTopicName() + APIMgtGatewayConstants.SUBSCRIBER_LINK_HEADER_SELF;
