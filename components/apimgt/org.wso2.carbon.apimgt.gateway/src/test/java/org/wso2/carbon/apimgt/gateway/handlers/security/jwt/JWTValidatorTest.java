...
public class JWTValidatorTest {
    ...
    public void setup() throws Exception {
        ...
        // Encoded jwt token
         String jwtTokenWithHeaderAndPayload = "eyJ4NXQiOiJOVEF4Wm1NeE5ETXlaRGczTVRVMVpHTTBNekV6T0RKaFpXSTRORE5sW" +
                 "kRVMU9HRmtOakZpTVEiL" +
    ...
    public void testAuthenticationWithAPISubscriptionFailure() throws Exception {
        ...
        try {
            ...
            GatewayUtils.validateAPISubscription("/unsubscribedPizzashack/1.0.0","1.0.0",
                    jwtClaimsSet, validJwtToken.split("\\."), true);
        } catch (APISecurityException e) {
    ...
    public void testGenerateAuthContext() throws Exception {
        ...
        AuthenticationContext authenticationContext = GatewayUtils.generateAuthenticationContext(splitToken[2],
                    jwtClaimsSet, api, null, APIConstants.UNLIMITED_TIER, true);
