...
public class SynapsePolicyAggregator {
    ...
    public static String generatePolicySequenceForUriTemplateSet(Set<URITemplate> uriTemplates, API api,
            String sequenceName, String flow, String pathToAchieve) throws APIManagementException, IOException {
        ...
        if (APIUtil.isAPILevelPolicySupportEnabled() && api != null) {
        ...
        if (!apiLevelPolicyRenderedList.isEmpty() && APIUtil.isAPILevelPolicySupportEnabled()) {
