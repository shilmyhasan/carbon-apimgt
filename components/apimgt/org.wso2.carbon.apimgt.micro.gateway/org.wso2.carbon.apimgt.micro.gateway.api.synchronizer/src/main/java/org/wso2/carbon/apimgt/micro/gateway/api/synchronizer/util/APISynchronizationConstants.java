...
public class APISynchronizationConstants {
    ...
    public static final String API_ADMIN_URL_PROPERTY = "api.admin.url";
    ...
    public static final String API_ADMIN_VIEW_GLOBAL_MEDIATION_POLICY_PATH = "/api/am/admin/{version}/policies/mediation";
